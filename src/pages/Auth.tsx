...
const Auth = () => {
  ...
  const handleAppleSignIn = async () => {
    ...
    if (error) {
      setError("Error al iniciar sesión con Apple. Inténtalo de nuevo.");
        ...
        <div className="w-full max-w-md">
          ...
          <Card className="shadow-2xl border-0">
            ...
            <CardContent className="space-y-6">
              ...
              <Button
                type="button"
                className="w-full h-12 text-base font-semibold bg-black text-white hover:bg-gray-800 transition-all duration-200"
